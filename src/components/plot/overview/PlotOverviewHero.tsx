...
import { CardHero, Link } from '@thyme/core';
import { PlotHero as PlotHeroIcon } from '@thyme/icons';
      ...
      <Grid xs={12} md={6} lg={4} item>
        <CardHero>
          ...
          <Typography variant="body1">
            <Trans>
              {'Plots are allocated space on your hard drive used to farm and earn Thyme. '}
              <Link target="_blank" href="https://github.com/Thyme-Network/thyme-blockchain/wiki/Network-Architecture">Learn more</Link>
            </Trans>
          </Typography>
          <Button
