...
import icon from '../../assets/img/thyme_circle.svg';
    ...
    <html>
      ...
      <body>
        ...
        <div className="copyright">
          Copyright (c) 2021 Thyme Network
        </div>
        <Spacer />
        <VersionsTable>
          {versions?.electron && (
        ...
        <BugReport href="https://github.com/Thyme-Network/thyme-blockchain/issues" target="_blank">
          Report an issue
        </BugReport>
        {'{{CSS}}'}
      </body>
