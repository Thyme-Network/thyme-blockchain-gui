...
import { Card, CopyToClipboard, Flex, Table } from '@thyme/core';
import type { RootState } from '../../modules/rootReducer';
import type { Row } from '../core/components/Table/Table';
import { mojo_to_thyme_string, mojo_to_colouredcoin_string } from '../../util/thyme';
...
const getCols = (type: WalletType) => [
  ...
  },
  {
    field: (row: Row) => type === WalletType.COLOURED_COIN
      ...
      : mojo_to_thyme_string(row.amount),
    title: <Trans>Amount</Trans>,
  },
  {
    field: (row: Row) => mojo_to_thyme_string(row.fee_amount),
