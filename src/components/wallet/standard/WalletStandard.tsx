...
import { AlertDialog, Flex, Card } from '@thyme/core';
...
import { mojo_to_thyme_string, thyme_to_mojo } from '../../../util/thyme';
  ...
  return (
    <Grid item xs={12}>
      <Box display="flex">
        ...
        <Box>
          <Typography variant="subtitle1">
            {mojo_to_thyme_string(props.balance)} {currencyCode}
          </Typography>
        </Box>
      </Box>
    </Grid>
  ...
  return (
    <Card title={<Trans>Balance</Trans>}>
      <BalanceCardSubSection
        ...
        tooltip={
          <Trans>
            This is the total amount of thyme in the blockchain at the current
      ...
      <BalanceCardSubSection
        ...
        tooltip={
          <Trans>
            This is the amount of Thyme that you can currently use to make
            transactions. It does not include pending farming rewards, pending
            incoming transactions, and Thyme that you have just spent but is not
...
function SendCard(props: SendCardProps) {
  ...
  function send() {
    ...
    const amount = thyme_to_mojo(amount_input.value);
    const fee = thyme_to_mojo(fee_input.value);
    ...
    if (address.includes('colour')) {
      dispatch(
        openDialog(
          <AlertDialog>
            <Trans>
              Error: Cannot send thyme to coloured address. Please enter a thyme
              address.
            </Trans>
          </AlertDialog>,
        ),
    ...
    if (address.slice(0, 12) === 'thyme_addr://') {
