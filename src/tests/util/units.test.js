...
describe("units", () => {
  describe("#getUnit", () => {
    it("gets unit of thyme", () => {
      const result = units.getUnit("thyme");
    ...
    it("gets unit of thyme using alias", () => {
  ...
  describe("#getDisplay", () => {
    it("gets display of thyme", () => {
      const result = units.getDisplay("thyme");
  ...
  describe("#setUnit", () => {
    ...
    it("modifies an existing unit", () => {
      units.setUnit("thyme", 9);

      const result = units.getUnit("thyme");

      expect(result).toEqual(9);

      units.setUnit("thyme", 1);
    });
  });
  describe("#setDisplay", () => {
